// Nutribot page functionality
console.log('[Nutribot] Script loaded');
document.addEventListener('DOMContentLoaded', function() {
    console.log('[Nutribot] DOMContentLoaded');
    setupNavigation();
    setGreeting();
});
...
function setupNavigation() {
    console.log('[Nutribot] Setting up navigation');
    ...
    navItems.forEach(item => {
        item.addEventListener('click', function() {
            ...
            console.log(`[Nutribot] Navigation clicked: ${text}`);
            switch(text) {
                case 'Home':
