document.getElementById('nutrition-form').addEventListener('submit', async function(e) {
    ...
    if (!input) {
        ...
        resultDiv.innerHTML = '<span style="color:#F26522;">Please enter foods to analyze.</span>';
        return;
    }
    
    console.log('Starting nutrition analysis...');
    resultDiv.innerHTML = '<div style="text-align:center;"><i class="fa fa-spinner fa-spin" style="color:#F26522;font-size:1.2rem;"></i><br><span style="color:#F26522;font-weight:bold;">Analyzing nutrition...</span></div>';
    ...
    try {
        ...
        resultDiv.innerHTML = `
            <div style="background:#f8d7da;border:1px solid #f5c6cb;border-radius:12px;padding:16px;">
                ...
                <span style="color:#721c24;">Error analyzing nutrition. Please try again later.</span>
            </div>
        `;
    }
});
